...
export interface Limits { doc: number; sec: number; entity: number; }
...
export const NODE_TYPES = ["全部", "Document", "Section", "Image", "Tool", "Material", "Process", "Constraint"] as const;
