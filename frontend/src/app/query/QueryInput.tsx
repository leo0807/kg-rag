...
export default function QueryInput({
    query, strategy, loading, streaming, hasResult, historyLen,
    onQuery, onStrategy, onSubmit, onExport,
}: Props) {
    return (
        <>
            <textarea
            ...
            <div className="flex gap-2 mt-3 mb-4 flex-wrap">
                {strategies.map(s => (
                    <button key={s.value} onClick={() => onStrategy(s.value)} title={s.desc}
            ...
            <div className="flex items-center gap-3 mb-8">
                <button onClick={onSubmit} disabled={!query.trim() || loading || streaming}
                ...
                <button onClick={onExport} disabled={!hasResult || streaming}
