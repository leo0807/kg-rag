      ...
      {showCreate && (
        <div className="bg-gray-900 border border-indigo-700/50 rounded-2xl p-4 sm:p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <div>
              <label
                htmlFor="admin-create-department"
                className="text-xs text-gray-500 mb-1 block"
              >
                部门
              </label>
          ...
          <div className="pt-1">
            <div className="text-xs text-gray-500 mb-2 block">用户权限</div>
              ...
              {[
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      setCreateForm((f) => ({ ...f, is_admin: opt.value }))
                    }
            ...
            {users.map((u) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={`px-2 py-0.5 rounded text-xs ${u.is_admin ? "bg-indigo-500/20 text-indigo-400" : "bg-gray-700 text-gray-400"}`}
                  >
                    {u.is_admin ? "管理员" : "普通用户"}
                  </span>
                </td>
                <td className="px-4 py-3">
                  <span
                    className={`px-2 py-0.5 rounded text-xs ${u.is_active ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                  >
                    {u.is_active ? "启用" : "禁用"}
                  </span>
                </td>
