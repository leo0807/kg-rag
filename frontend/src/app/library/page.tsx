...
import BatchIngestPanel        from "@/app/admin/ingest/page";
...
function ImageAnalysisBadge({
    status, imageCount, analyzedCount,
}: {
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 border-b border-gray-800 mb-5">
                ...
                {isAdmin && (
                    <button onClick={() => switchTab("ingest")}
                ...
                <button onClick={() => switchTab("reprocess")}
            ...
            {activeTab === "ingest" && isAdmin && <LibraryIngestTab onDone={() => { switchTab("list"); setPage(1); setSearch(""); }} />}
                    ...
                    {loading && docs.length === 0 ? <SkeletonTable rows={10} /> : !fetchError && (
                        <div className="relative">
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {docs.length === 0 && (
                                        <tr><td colSpan={6} className="py-12 text-center text-sm text-gray-500">
                                    ...
                                    {docs.map(doc => (
                                        <tr key={doc.doc_id} className="border-b border-gray-800/50">
                                            ...
                                            <td className="py-3 pr-4 text-gray-400">{doc.section_count}</td>
                                            <td className="py-3">
                                                <ImageAnalysisBadge
