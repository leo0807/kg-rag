...
| 优先级 | 条目数 | 总估时 | 变更说明 |
|--------|--------|--------|---------|
| P0     | 5      | 3.5 人天 | F038 决策路径 B 已关闭（-1条，估时不变） |
| P1     | 7      | 9.0 人天 | F055 验证升 🟢 已关闭（-1条 -1天）；F076 确认需实现（+0.5天） |
| P2     | 4      | 10.0 人天 | F100 已实现关闭（-1条 -0.5天） |
| 合计   | 16     | 22.5 人天 | 较初版 -3条 -1天 |

> 估时按"单人开发，串行"计，不含 code review 时间。
> 最后更新：2026-05-17 批次 2 A1 完成后。
