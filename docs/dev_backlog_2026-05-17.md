...
| P2     | 6      | 11.5 人天 | F100 已实现关闭；F121 已关闭；F122/F123 新增（+2条 +1.5天） |
| P3     | 1      | 7.0 人天  | F124 新增（+1条 +7.0天） |
| 合计   | 15     | 28.5 人天 | 较初版 -4条 +5.5天 |

> 估时按"单人开发，串行"计，不含 code review 时间。
> 最后更新：2026-05-18（F060/F120/F121 已关闭；F122/F123/F124 新增；F022 评估完成；预存在改动分类完成）。
